...
There are two ways to change the controls: Either by using the options menu accessible inside the game or by editing [minetest.conf](https://wiki.luanti.org/Minetest.conf "Minetest.conf"). See minetest.conf.example to learn the setting names. Note that some controls are fixed and cannot be changed at all.
...
You'll need to use an external program to bind a controller. See [Gamepads](https://wiki.luanti.org/Gamepads "Gamepads") for more info.
...
With `minetest.conf`, you can change the controls which are unavailable in the settings menu. See [minetest.conf#Controls](https://wiki.luanti.org/Minetest.conf#Controls "Minetest.conf") for more information.

Inventory controls
------------------

See [Inventory#Controls](https://wiki.luanti.org/Inventory#Controls "Inventory").

Console controls
----------------

See [Console#Controls overview](https://wiki.luanti.org/Console#Controls_overview "Console").