...
- [Starting from 5.16.0](https://github.com/luanti-org/luanti/pull/16815), mouse buttons are specified using `MOUSE_BUTTON_num`, where `num` is the numeric index of the mouse button. Irrlicht keycodes representing mouse buttons (e.g. `KEY_LBUTTON`) are deprecated and automatically converted.
